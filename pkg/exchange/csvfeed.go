...
func (c CSVFeed) GetAssetsInfo(pair string) model.AssetInfo {
...
func (c CSVFeed) GetLastQuote(_ context.Context, _ string) (float64, error) {
...
func (c CSVFeed) GetCandlesByPeriod(_ context.Context, pair, timeframe string,
...
func (c *CSVFeed) GetCandlesByLimit(_ context.Context, pair, timeframe string, limit int) ([]model.Candle, error) {
...
func (c CSVFeed) SubscribeCandle(_ context.Context, pair, timeframe string) (chan model.Candle, chan error) {
